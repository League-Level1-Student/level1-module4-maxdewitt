...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
        ...
        JOptionPane.showMessageDialog(null, "Press the matching key when Simon says so. Otherwise the opposite key.");
	...
	private void showImage() {
		...
		frame1.add(getNextRandomImage());

		// 8. Set the name of your frame
        frame1.setName("pictureframe");
		// 9. Pack the frame
        frame1.pack();
